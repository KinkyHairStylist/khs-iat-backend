  ...
  <tr>
    <td style="padding:24px 40px 32px 40px; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif; text-align:center;">
      ...
      <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto 16px auto;">
        <tr>
          <td style="padding:0 6px;"><a href="#" style="display:inline-block; width:32px; height:32px; line-height:32px; border-radius:50%; background-color:#f1f1f1; text-align:center; text-decoration:none;"><img src="https://cdn.simpleicons.org/facebook/${ICON_COLOR}" width="16" height="16" alt="Facebook" style="display:inline-block; vertical-align:middle; border:0;" /></a></td>
          <td style="padding:0 6px;"><a href="#" style="display:inline-block; width:32px; height:32px; line-height:32px; border-radius:50%; background-color:#f1f1f1; text-align:center; text-decoration:none;"><img src="https://cdn.simpleicons.org/linkedin/${ICON_COLOR}" width="16" height="16" alt="LinkedIn" style="display:inline-block; vertical-align:middle; border:0;" /></a></td>
          <td style="padding:0 6px;"><a href="#" style="display:inline-block; width:32px; height:32px; line-height:32px; border-radius:50%; background-color:#f1f1f1; text-align:center; text-decoration:none;"><img src="https://cdn.simpleicons.org/x/${ICON_COLOR}" width="16" height="16" alt="X" style="display:inline-block; vertical-align:middle; border:0;" /></a></td>
          <td style="padding:0 6px;"><a href="#" style="display:inline-block; width:32px; height:32px; line-height:32px; border-radius:50%; background-color:#f1f1f1; text-align:center; text-decoration:none;"><img src="https://cdn.simpleicons.org/instagram/${ICON_COLOR}" width="16" height="16" alt="Instagram" style="display:inline-block; vertical-align:middle; border:0;" /></a></td>
        </tr>
      </table>
