...
export const BusinessCloudinaryConfig = (configService: ConfigService) => {
  cloudinary.config({
    cloud_name:
      configService.get<string>('BUSINESS_CLOUDINARY_CLOUD_NAME') ??
      configService.get<string>('CLOUDINARY_CLOUD_NAME'),
    api_key:
      configService.get<string>('BUSINESS_CLOUDINARY_API_KEY') ??
      configService.get<string>('CLOUDINARY_API_KEY'),
    api_secret:
      configService.get<string>('BUSINESS_CLOUDINARY_API_SECRET') ??
